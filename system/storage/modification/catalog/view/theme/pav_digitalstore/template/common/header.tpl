...
$helper->addScript( 'catalog/view/javascript/common.js?v=2.1' );

$helper->addScript( 'catalog/view/theme/'.$themeName.'/javascript/common.js?v=2.1' );
...
<div class="modal fade" id="login-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
      ...
      <div class="modal-content">
        <div class="modal-header" align="center">
          <img class="img-circle lazy-load-image" data-src="https://img.icons8.com/bubbles/100/000000/guest-male.png" id="img_logo" src="https://i.imgur.com/DChoa49.jpg"/>
