...
// Text
            ...
            $_['entry_voucher']             = 'Enter your voucher here:';
            $_['use_voucher']               = 'Use Voucher Code';
            $_['text_voucher_success']      = 'Success:Your discount voucher has been successfuly applied to your order!. You will see it in the next checkout step';
            $_['button_voucher']            = 'Apply Voucher';
            $_['error_empty_voucher']       = 'Warning: Please enter the code of gift voucher to use!';
