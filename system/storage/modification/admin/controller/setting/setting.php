...
$data['config_whatsappid'] = $this->config->get('config_whatsappid');
		...
		if (isset($this->request->post['config_combo_offer_percentage_2'])) {
			$data['config_combo_offer_percentage_2'] = $this->request->post['config_combo_offer_percentage_2'];
		} else {
			$data['config_combo_offer_percentage_2'] = $this->config->get('config_combo_offer_percentage_2');
		}

		if (isset($this->request->post['config_combo_offer_percentage_3'])) {
			$data['config_combo_offer_percentage_3'] = $this->request->post['config_combo_offer_percentage_3'];
		} else {
			$data['config_combo_offer_percentage_3'] = $this->config->get('config_combo_offer_percentage_3');
		}
