<ul id="menu">
  ...
  <li id="catalog"><a class="parent"><i class="fa fa-tags fa-fw"></i> <span><?php echo $text_catalog; ?></span></a>
    <ul>
      ...
      <li><a href="<?php echo $home_configuration; ?>"><?php echo "Home configuration"; ?></a></li>
      <li><a href="<?php echo $image_upload; ?>"><?php echo "Image Upload"; ?></a></li>
  ...
  <li id="sale"><a class="parent"><i class="fa fa-shopping-cart fa-fw"></i> <span><?php echo $text_sale; ?></span></a>
    <ul>
      ...
      <li><a href="<?php echo $order_redeem; ?>"><?php echo "Redemption orders"; ?></a></li>
