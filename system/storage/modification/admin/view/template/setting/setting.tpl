...
<input class="form-control" id="tl-whatsapp" type="text" name="config_whatsapptl" placeholder="whatsapp" value="<?php echo $config_whatsapptl; ?>" />
            ...
            <div class="tab-pane" id="tab-option">
              <fieldset>
                ...
                <div class="form-group required">
                  <label class="col-sm-2 control-label" for="config_combo_offer_percentage_2">Combo Offer Percentage for 2 items</label>
                  <div class="col-sm-10">
                    <input type="text" name="config_combo_offer_percentage_2" value="<?php echo $config_combo_offer_percentage_2; ?>" placeholder="Enter percentage(%) for Combo Offer Percentage 2 items" id="config_combo_offer_percentage_2" class="form-control" />

                  </div>
                </div>

                <div class="form-group required">
                  <label class="col-sm-2 control-label" for="config_combo_offer_percentage_3">Combo Offer Percentage for 3 items</label>
                  <div class="col-sm-10">
                    <input type="text" name="config_combo_offer_percentage_3" value="<?php echo $config_combo_offer_percentage_3; ?>" placeholder="Enter percentage(%) for Combo Offer Percentage 3 items" id="config_combo_offer_percentage_3" class="form-control" />
