...
<div id="content">
  ...
  <div class="container-fluid">
            ...
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input_product_compare"><span data-toggle="tooltip" title="<?php echo $help_tag; ?>"><?php echo "Product Compare ID's"; ?></span></label>
                    <div class="col-sm-10">
                      <input type="text" name="product_description[<?php echo $language['language_id']; ?>][tag]" value="" placeholder="Product Compare ID's" id="input_product_compare" class="form-control" />
                    </div>
                  </div>
                </div>
                <?php } ?>
    ...
    <!-- Product bundle 2 start-->

      <div class="form-group">
        <label class="col-sm-2 control-label" for="input-bundled">
           <span data-toggle="tooltip" title="<?php echo $help_related; ?>">Bundled product two</span>
         </label>
         <div class="col-sm-10">
           Quantity: <input type="text" name="bundle_qty_2" value="1" id="bundle_qty_2" class="form-control" />
            Product (autocomplete) : <input type="text" name="bundled_2" value="" placeholder="<?php echo $entry_bundled; ?>" id="input-bundled_2" class="form-control" />
             <div id="product-bundled_2" class="well well-sm" style="height: 150px; overflow: auto;">
               <?php $bundle_counter=0; foreach ($product_bundled_2 as $product_bundle) { $bundle_counter++; ?>
                 <div id="product-bundled_2<?php echo $product_bundle['product_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $product_bundle['qty']; ?> x <?php echo $product_bundle['name']; ?>
                   <input type="hidden" name="product_bundled_2[<?php echo $bundle_counter; ?>][product_id]" value="<?php echo $product_bundle['product_id']; ?>" />
                   <input type="hidden" name="product_bundled_2[<?php echo $bundle_counter; ?>][qty]" value="<?php echo $product_bundle['qty']; ?>" />
                 </div>
               <?php } ?>
             </div>
           </div>
    ...
    <!--Product bundle 2 end-->


			<div class="form-group">
				<label class="col-sm-2 control-label" for="input-bundled"><span data-toggle="tooltip" title="<?php echo $help_related; ?>"><?php echo $entry_bundled; ?></span></label>
				<div class="col-sm-10">
				Quantity:  <input type="text" name="bundle_qty" value="1" id="bundle_qty" class="form-control" />
				Product (autocomplete) :
					<input type="text" name="bundled" value="" placeholder="<?php echo $entry_bundled; ?>" id="input-bundled" class="form-control" />
					<div id="product-bundled" class="well well-sm" style="height: 150px; overflow: auto;">
						<?php $bundle_counter=0; foreach ($product_bundled as $product_bundle) { $bundle_counter++; ?>
						<div id="product-bundled<?php echo $product_bundle['product_id']; ?>"><i class="fa fa-minus-circle"></i>  <?php echo $product_bundle['qty']; ?> x <?php echo $product_bundle['name']; ?>
							<input type="hidden" name="product_bundled[<?php echo $bundle_counter; ?>][product_id]" value="<?php echo $product_bundle['product_id']; ?>" />
							<input type="hidden" name="product_bundled[<?php echo $bundle_counter; ?>][qty]" value="<?php echo $product_bundle['qty']; ?>" />
						</div>
						<?php } ?>
					</div>
				</div>
              ...
              <div class="table-responsive">
                <table id="faqs" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr id="faq-row<?php echo $faq_row; ?>">
                      <td class="text-left" style="width: 40%;"><input type="text" name="product_faqs[<?php echo $faq_row; ?>][faq_question]" value="<?php echo $product_attribute['faq_question']; ?>" placeholder="Add Question" class="form-control" />
                        <input type="hidden" name="product_faqs[<?php echo $faq_row; ?>][faq_id]" value="<?php echo $product_attribute['faq_id']; ?>" /></td>
                      <td class="text-left">
                    ...
                    <!-- <tr id="faqs-row">
                      ...
                      <td class="text-left">
                        ...
                        <div class="input-group">
                          <textarea rows="1" placeholder="add your answer" class="form-control"></textarea>
                        </div>


                      </td>
                      <td class="text-left"><button type="button" onclick="$('#faqs-row<?php echo $faqs_row; ?>').remove();" class="btn btn-danger"><i class="fa fa-minus"></i></button>
                      </td>
                    </tr> -->
                  ...
                  <tfoot>
                    <tr>
                      <td colspan="2"></td>
                      <td class="text-left"><button type="button" onclick="addfaqs();" class="btn btn-primary"><i class="fa fa-plus"></i></button></td>
                    </tr>
                  </tfoot>
                </table>
              </div>
...
$('#product-download').delegate('.fa-minus-circle', 'click', function() {
  $(this).parent().remove();
			...
			var bundle_counter=<?php echo $bundle_counter; ?>;
			$('input[name=\'bundled\']').autocomplete({
			    ...
			    bundle_counter++;
					...
					$('#product-bundled').append('<div id="product-bundled' + item['value'] + '"><i class="fa fa-minus-circle"></i> ' + $('#bundle_qty').val()+' x '+item['label'] + '<input type="hidden" name="product_bundled['+bundle_counter+'][product_id]" value="' + item['value'] + '" /><input type="hidden" name="product_bundled['+bundle_counter+'][qty]" value="' + $('#bundle_qty').val() + '" /></div>');
				}
			});
      ...
      // bundle product 2 start



      var bundle_counter=<?php echo $bundle_counter; ?>;
      $('input[name=\'bundled_2\']').autocomplete({
        'source': function(request, response) {
          $.ajax({
            url: 'index.php?route=catalog/product/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
            dataType: 'json',
        ...
        'select': function(item) {
          console.log(item);
          bundle_counter++;
          $('input[name=\'bundled_2\']').val('');

          $('#product-bundled_2' + item['value']).remove();

          $('#product-bundled_2').append('<div id="product-bundled_2' + item['value'] + '"><i class="fa fa-minus-circle"></i> ' + $('#bundle_qty_2').val()+' x '+item['label'] + '<input type="hidden" name="product_bundled_2['+bundle_counter+'][product_id]" value="' + item['value'] + '" /><input type="hidden" name="product_bundled_2['+bundle_counter+'][qty]" value="' + $('#bundle_qty_2').val() + '" /></div>');
        }
      });

      $('#product-bundled_2').delegate('.fa-minus-circle', 'click', function() {
        $(this).parent().remove();
      });



      // bundle product 2 end
...
//--></script>
  <script type="text/javascript"><!--
   var faqs_row = <?php echo $faq_row; ?>;
   function addfaqs() {
    html  = '<tr id="faqs-row' + faqs_row + '">';
  html += '  <td class="text-left" style="width: 20%;"><input type="text" name="product_faqs[' + faqs_row + '][faq_question]" value="" placeholder="add question" class="form-control" /><input type="hidden" name="product_faqs[' + faqs_row + '][faqs_id]" value="" /></td>';
  html += '  <td class="text-left">';

  html += '<div class="input-group" style="width: 100%;"><textarea name="product_faqs[' + faqs_row + '][faq_answer]" rows="5" placeholder="add your answer" class="form-control"></textarea></div>';

  html += '  </td>';
  html += '  <td class="text-left"><button type="button" onclick="$(\'#faqs-row' + faqs_row + '\').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus"></i></button></td>';
    html += '</tr>';
...
function deletefaq(row_id,faq_id){

            $.ajax({
                type: "POST",
                url: 'index.php?route=catalog/attribute/deletefaqs&token=<?php echo $token; ?>',
                data: "id="+faq_id,
                success: function(data){


                        $("#faq-row"+row_id).remove();
                }
