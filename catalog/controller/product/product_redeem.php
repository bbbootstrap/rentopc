<?php
class Controllerproductproductredeem extends Controller {
	private $error = array();
	...
	public function index() {
		...
		if ($product_info) {
			...
			$data['breadcrumbs'][] = array(
				...
				'href' => $this->url->link('product/product_redeem', $url . '&product_id=' . $this->request->get['product_id'])
			);
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/product_redeem.tpl')) {
				$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/product/product_redeem.tpl', $data));
			} else {
				$this->response->setOutput($this->load->view('default/template/product/product_redeem.tpl', $data));
			}
		} else {
			$url = '';
