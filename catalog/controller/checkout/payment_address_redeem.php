<?php
class ControllerCheckoutPaymentAddressredeem extends Controller {
	...
	public function save() {
		...
		if ((!$this->cart->hasProducts_redeem() && empty($this->session->data['vouchers'])) || (!$this->cart->hasStock() && !$this->config->get('config_stock_checkout'))) {
