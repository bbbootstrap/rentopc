   ...
   <section id="sidebar-main" class="col-md-<?php echo $SPAN[1];?>"><div id="content"><?php echo $content_top; ?>
      ...
      <form class="form-horizontal">
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <!-- <textarea cols="40" rows="5" placeholder="<?php echo $entry_code; ?>" id="input-code" class="form-control" readonly><?php echo $code; ?></textarea> -->
            <input type="text" name="" id="input-code" value="<?php echo $code; ?>" class="form-control" readonly style="background-color: #ddd;">
          </div>
        </div>
        <div class="form-group">
