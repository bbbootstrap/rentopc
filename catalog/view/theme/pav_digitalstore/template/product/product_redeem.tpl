...
<div class="container">
  ...
  <div class="row"><?php if( $SPAN[0] ): ?>
   ...
   <section id="sidebar-main" class="col-md-<?php echo $SPAN[1];?>"><div id="content"><?php echo $content_top; ?>
        ...
        <?php require( PAVO_THEME_DIR."/template/product/product_detail_hitech_redeem.tpl" );  ?>
...
<script type="text/javascript"><!--
$('#button-cart-buy-redeem').on('click', function() {
	$.ajax({
		url: 'index.php?route=checkout/cart_redeem/add',
		type: 'post',
		...
		dataType: 'json',
		beforeSend: function() {
			$('#button-cart-buy-redeem').button('loading');
		},
		complete: function() {
			$('#button-cart-buy-redeem').button('reset');
		},
		error: function() {
			alert("Hello");
		},
		success: function(json) {
			...
			//alert("Hello");
			 ...
			 if (json['success']) {
			 	...
			 	window.location='index.php?route=checkout/cart_redeem';
