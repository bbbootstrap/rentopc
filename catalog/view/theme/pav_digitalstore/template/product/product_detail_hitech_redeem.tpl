...
<div class="product-info">
	...
	<div class="col-xs-12 col-sm-<?php echo $cols[1]; ?> col-md-<?php echo $cols[1]; ?> col-lg-<?php echo $cols[1]; ?>">
         ...
         <?php if ($price) { ?>
            <div class="price">
                <ul class="list-unstyled">
                    <span class="price-new"><?php echo $points; ?> Credits </span>
                    <!--
                    <?php if ($tax) { ?>
               ...
               <!--  <ul>
                <li style="    font-size: 12px;color: #6e6e6e;">(Additional taxes@18% apply at checkout.)</li>
        ...
        <div class="description">
                <p>
                    <?php echo "In case you are facing any issues while redeeming points, feel free to "; ?>

                    <a href="#" id="jivochatclick" style="color: #e17258;">Chat with our agent</a>

                    <!--

                    <button onclick="window.fcWidget.open();window.fcWidget.show();">Chat with our agent</button>
                ...
                <p>
                <i class="fam fa fa-eye" style="background-color: #5bc0de;"></i>
        ...
        <!-- AddThis Button END -->
         <ul class="list-unstyled description">
            ...
            <!-- <?php if ($reward) { ?>
                <li><b><?php echo $text_reward; ?></b><span class="reward"> <?php echo $reward; ?></span></li>
            <?php } ?>
            <?php if ($points) { ?>
                <li><b><?php echo $text_points; ?></b> <?php echo $points; ?></li>
            <?php } ?> -->

            <!-- <li><b><?php echo "Offers:"; ?></b><span style="color: #6cb935;"><?php echo " Apply Mbuy coupon & Get 5% off."; ?></span></li>
             -->
            <li><b class="availability"><?php echo $text_stock; ?></b> <span style="color: #6cb935;"><?php echo $stock; ?></span></li>
            <!-- <li><b class="availability">Services: </b>

                                    <i class="fa fa-truck gap fa-color"></i><span class="gap">Free Shipping</span>

                                    <i class="fa fa-repeat gap fa-color"></i><span class="gap">Easy replacement</span>
 ...
 -->
               <?php if ($logged) { ?>
               <div class="cart pull-left"><input type="button" value="<?php echo 'Redeem Now'; ?>" id="button-cart-buy-redeem" class="button" /></div>


                    <?php } else{  ?>
               <a href="#" data-toggle="modal" data-target="#login-modal" data-abc="true">
               <div class="cart pull-left"><input type="button" value="<?php echo 'Redeem Now'; ?>" class="button" /></div>
              ...
              <!-- <div class="wishlist-compare pull-left">
                <span class="wishlist"><a class="fa fa-heart" onclick="wishlist.addwishlist('<?php echo $product_id; ?>');" data-placement="top" data-toggle="tooltip" data-original-title="<?php echo $button_wishlist; ?>"><span><?php echo $button_wishlist; ?></span></a></span>
                <span class="compare"><a class="fa fa-retweet" onclick="compare.addcompare('<?php echo $product_id; ?>');" data-placement="top" data-toggle="tooltip" data-original-title="<?php echo $button_compare; ?>"><span><?php echo $button_compare; ?></span></a></span>
            </div> -->
    ...
    <div class="tab-content">
        ...
        <?php if ($review_status) { ?>
            ...
            <div class="tab-pane" id="tab-review">
                ...
                <div id="review"></div>
                <p> <a href="#review-form"  class="popup-with-form button" onclick="$('a[href=\'#tab-review\']').trigger('click'); return false;" ><?php echo $text_write; ?></a></p>
