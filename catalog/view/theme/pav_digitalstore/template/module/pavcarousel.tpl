<?php $id = rand(1,10); $width =  100/$columns; // echo $columns;die;?>
   ...
   <div id="pavcarousel<?php echo $id;?>" class="box carousel slide pavcarousel hidden-xs">
		...
		<div class="bbb_bestselling_title_container">
                    <h3 class="bbb_shopbybrand_title">Shop By Brands</h3>
                    <div class="bbb_bbbrands_nav_container">
                        <a href="https://www.rentopc.com/laptop-notebook"><h5>View All <i class="fa fa-arrow-right"></i></h5></a>
                    </div>
