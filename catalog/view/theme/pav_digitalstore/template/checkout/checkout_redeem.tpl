...
$(document).delegate('#button-payment-address', 'click', function() {
    ...
    $.ajax({
        url: 'index.php?route=checkout/payment_address_redeem/save',
        type: 'post',
        ...
        success: function(json) {
            ...
            if (json['redirect']) {
                ...
                <?php } else { ?>
                $.ajax({
                    url: 'index.php?route=checkout/payment_method_redeem',
                    dataType: 'html',
                    success: function(html) {
                        $('#collapse-payment-method .panel-body').html(html);
...
$(document).delegate('#button-payment-method', 'click', function() {
    $.ajax({
        url: 'index.php?route=checkout/payment_method_redeem/save', 
        type: 'post',
        ...
        success: function(json) {
            ...
            if (json['redirect']) {
                ...
                $.ajax({
                    url: 'index.php?route=checkout/confirm_redeem',
                    dataType: 'html',
                    success: function(html) {
