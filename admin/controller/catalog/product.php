...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['product_bundled'])) { $product_bundled = $this->request->post['product_bundled']; } elseif (isset($this->request->get['product_id'])) { $product_bundled = $this->model_catalog_product->getProductBundle($this->request->get['product_id']); } else { $product_bundled = array(); } $data['product_bundled'] = array(); foreach ($product_bundled as $bundle) { $related_info = $this->model_catalog_product->getProduct($bundle['product_id']); if ($related_info) { $data['product_bundled'][] = array( 'product_id' => $related_info['product_id'], 'name' => $related_info['name'], 'qty'=>$bundle['qty'] ); } }
