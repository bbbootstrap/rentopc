...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['home_configuration'] = $this->url->link('catalog/homeconfiguration', 'token=' . $this->session->data['token'], 'SSL');
		$data['image_upload'] = $this->url->link('catalog/imageupload', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['order_redeem'] = $this->url->link('sale/order_redeem', 'token=' . $this->session->data['token'], 'SSL');
