...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['combo_offer_percentage_2'])) {
			$data['combo_offer_percentage_2'] = $this->request->post['combo_offer_percentage_2'];
		} else {
			$data['combo_offer_percentage_2'] = $this->config->get('combo_offer_percentage_2');
		}

		if (isset($this->request->post['combo_offer_percentage_3'])) {
			$data['combo_offer_percentage_3'] = $this->request->post['combo_offer_percentage_3'];
		} else {
			$data['combo_offer_percentage_3'] = $this->config->get('combo_offer_percentage_3');
		}
