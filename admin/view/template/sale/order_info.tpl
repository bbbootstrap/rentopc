      ...
      <div class="col-md-4">
        <div class="panel panel-default">
          <div class="panel-heading">
            ...
            // val rewards = '<?php echo $reward; ?>'; -->

            <input type="hidden" id="customer_id" value="<?php echo $customer_id; ?>" />
            <input type="hidden" id="reward" value="<?php echo $reward; ?>" />
          </div>
          <table class="table">
            <tr>
...
$('#button-history').on('click', function() {
  ...
  // alert(rewards);
	...
	$.ajax({
		...
		type: 'post',
		dataType: 'json',
		data: 'order_status_id=' + encodeURIComponent($('select[name=\'order_status_id\']').val()) + '&customer_id='+customer_id+ '&reward='+reward+ '&notify=' + ($('input[name=\'notify\']').prop('checked') ? 1 : 0) + '&override=' + ($('input[name=\'override\']').prop('checked') ? 1 : 0) + '&append=' + ($('input[name=\'append\']').prop('checked') ? 1 : 0) + '&comment=' + encodeURIComponent($('textarea[name=\'comment\']').val()),
		beforeSend: function() {
