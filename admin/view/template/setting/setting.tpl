          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-option">
              <fieldset>
                ...
                <div class="form-group required">
                  <label class="col-sm-2 control-label" for="combo_offer_percentage_2">Combo Offer Percentage 2 items</label>
                  <div class="col-sm-10">
                    <input type="text" name="config_product_limit" value="<?php echo $config_product_limit; ?>" placeholder="Enter percentage(%) for Combo Offer Percentage 2 items" id="combo_offer_percentage_2" class="form-control" />
                    <?php if ($error_product_limit) { ?>
                    <div class="text-danger"><?php echo $error_product_limit; ?></div>
                    <?php } ?>
                  </div>
