...
<div class="d-flex justify-content-center mt-100" style="margin-bottom: 155px;    padding-left: 70px;
    padding-right: 70px;">
      ...
      <div class="col-md-12">
          <div class="dropzone uploadfuzone fuzone">
              <div class="row">
                  ...
                  <div class="col-md-4">
                      <div class="snippet_image_div"> </div>
                  </div>
              </div> <input type="file" class="input" accept="image/*">
          </div>
